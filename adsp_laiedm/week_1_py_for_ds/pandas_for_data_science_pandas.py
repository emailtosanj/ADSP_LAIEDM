...
Original file is located at
    https://colab.research.google.com/drive/1tiTcPpKHswiXvfFbsj64Hf7bCyWfd9VK
"""
...
#display(Javascript('''google.colab.output.setIframeHeight(0, true, {maxHeight: 5000})''')) # Adjust 5000 as needed for desired height

#To set a specific maximum height for the output iframe:
  #from IPython.display import Javascript, display
...
#this line gets the display of 3 rows from 1 to 3
ss = store_data
ss.loc[1:3]['CustomerID']
...
#accessing first 3 rows with only location column
# Important: if there are other columns whic are to be accessed then in the second args provide
# the column names
store_data.loc[:3, ['location']]

#if all the rows to be selected for all the columns then
ss.loc[:,['location']]
